...
export default function FormsList(props: { closeFormsListCB: () => void }) {
  ...
  const editForm = (id: any) => setFormId(id);
        ...
        <>
          <div className="flex justify-between my-5">
            <button
              ...
              onClick={(_) => editForm(null)}
            >
              New Form
            </button>
            <button
              className="bg-indigo-500 py-2 px-3 text-white rounded-lg"
              onClick={props.closeFormsListCB}
            >
              Home
            </button>
          </div>
