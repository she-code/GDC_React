...
import { DropdownField, FormIntialState } from "../../../types/formTypes";
import { SubmissionType } from "../../../types/responseTypes";
import CustomHeader from "../../common/CustomHeader";

export default function SelectField(props: {
  state: FormIntialState;
  fieldIndex: number;
  responseState: SubmissionType;
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="ml-4  w-1/3">
        {(state?.formFields[fieldIndex] as DropdownField).options?.length >
        0 ? (
          <>
            <button
